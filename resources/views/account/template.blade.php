...
<head>
    ...
    <link href="https://bootstrap-4.ru/docs/5.0/examples/dashboard/dashboard.css" rel="stylesheet">
</head>
<body>
            ...
            <div class="col-lg-8 mx-auto p-3 py-md-5">
                ...
                <div class="row g-5">
                    <div class="col-md-6">
                        ...
                        <ul class="icon-list">
                            <li><a href="{!! route('posts') !!}" rel="noopener">My posts</a></li>
                        </ul>
                    </div>
...
<script src="https://bootstrap-4.ru/docs/5.0/examples/dashboard/dashboard.js"></script>
</body>
</html>
